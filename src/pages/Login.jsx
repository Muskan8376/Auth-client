  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <form onSubmit={onSubmitHandler}>
        ...
        value={email}
        className=' bg-transparent  outline-none' placeholder='Email id' required/>
        </div>
        ...
        value={password}
         className=' bg-transparent  outline-none' placeholder='Password' required/>
        </div>
        <p onClick={()=>navigate('/reset-password')}
        className='mb-4 text-indigo-500 cursor-pointer'> Forgot Password? </p>

        <button className='w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-500 to bg-indigo-800 text-white font-medium'>{state}</button>
      </form>
